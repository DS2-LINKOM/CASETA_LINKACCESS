...
public class EscaneoVisitaSalidaActivity extends mx.linkom.caseta_linkaccess.Menu {
    ...
    private void buscarPlacas() {
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/placasHoy.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void cargarSpinner(){
        ...
        try{
            ...
            ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line,arrayPlacas);
    ...
    public void placas() {
        if (placas.getText().toString().equals("")) {
            ...
            String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php8.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
    ...
    public void placas2(final String id_visita) {
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php9.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
                ...
                if (response.length() > 0) {
                    try {
                        ...
                        if (ja2.getString(5).equals("2")) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.AccesosMultiplesSalidasActivity.class);
                            startActivity(i);
                            finish();
                        } else if (palabra.equals("M")) {
                            Conf.setST("Aceptado");
                            ...
                            Conf.setQR(ja2.getString(12));
                            Global.setBuscarPorPlaca(true);
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.AccesosSalidasActivity.class);
                            startActivity(i);
                            finish();
                        }
    ...
    public void QR() {
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php1.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
