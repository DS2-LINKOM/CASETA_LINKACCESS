...
public class PlacasInfoActivity extends mx.linkom.caseta_linkaccess.Menu{
    ...
    public void RegPlacas(){
        ...
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/placas_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void RegPlacas2(){
        ...
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/placas_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void Usuario(final String IdUsu){
        ...
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/placas_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void dtlLugar(final String idUsuario){
        String url = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/placas_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.ReportesActivity.class);
