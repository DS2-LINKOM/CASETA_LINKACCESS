...
import mx.linkom.caseta_linkaccess.adaptadores.ListasClassGrid;
...
public class ListaGrupalEntradaActivity extends mx.linkom.caseta_linkaccess.Menu {
    ...
    public void invitados() {
        String URL = "https://linkaccess.kap-adm.mx//plataforma/casetaV2/controlador/link_access/vst_gru_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
