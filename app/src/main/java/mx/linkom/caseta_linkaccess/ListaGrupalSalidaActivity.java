...
public class ListaGrupalSalidaActivity extends mx.linkom.caseta_linkaccess.Menu {
    ...
    public void invitados() {
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_gru_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
