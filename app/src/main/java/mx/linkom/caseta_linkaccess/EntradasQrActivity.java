...
public class EntradasQrActivity extends mx.linkom.caseta_linkaccess.Menu {
        ...
        Registro2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Conf.getTipoQr().equals("Normal")) {
                    ...
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.AccesosGrupalActivity.class);
                    startActivity(i);
                    finish();
                }
            }});
