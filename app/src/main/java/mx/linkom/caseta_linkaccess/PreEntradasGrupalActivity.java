...
import mx.linkom.caseta_linkaccess.detectPlaca.DetectarPlaca;
import mx.linkom.caseta_linkaccess.detectPlaca.objectDetectorClass;
import mx.linkom.caseta_linkaccess.offline.Database.UrisContentProvider;
import mx.linkom.caseta_linkaccess.offline.Global_info;
import mx.linkom.caseta_linkaccess.offline.Servicios.subirFotos;

public class PreEntradasGrupalActivity extends mx.linkom.caseta_linkaccess.Menu {
    mx.linkom.caseta_linkaccess.Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Conf = new mx.linkom.caseta_linkaccess.Configuracion(this);
...
//ALETORIO3
    ...
    public void submenu(final String id_app) {
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/menu_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Visita() {
        ...
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_gru_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Usuario(final String IdUsu) { //DATOS USUARIO
        ...
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void dtlLugar(final String idUsuario) {
        String URLResidencial = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php3.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
    ...
    public void salidas(final String id_visitante) {
        String URLResidencial = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php4.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
    ...
    public void Dtl_pre() {
        ...
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_reg_8.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Registrar() {
        ...
        if ((Placas.getText().toString().equals("") && !Global.getFotoPlaca()) || (Global.getFotoPlaca() && editTextPlacasPorFoto.getText().toString().equals(""))) {
            ...
            String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php5.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    if (response.equals("error")) {
                        ...
                        alertDialogBuilder
                                ...
                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Toast.makeText(getApplicationContext(), "Visita No Registrada", Toast.LENGTH_SHORT).show();
                                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.EscaneoVisitaActivity.class);
                                        startActivity(i);
                                        finish();
                                    }
                                }).create().show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.EntradasSalidasActivity.class);
