...
public class  AccesosMorososActivity extends mx.linkom.caseta_linkaccess.Menu {
    ...
    public void Registrar (){
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/grupokap_access/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
