...
public class  AccesosMorososActivity extends mx.linkom.caseta_linkaccess.Menu {
    Configuracion Conf;
    ...
    public void Registrar (){
        ...
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
