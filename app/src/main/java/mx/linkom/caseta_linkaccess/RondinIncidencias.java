...
public class RondinIncidencias  extends mx.linkom.caseta_linkaccess.Menu{
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://linkaccess.kap-adm.mx//plataforma/casetaV2/controlador/link_access/rondines_incidencias.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            ...
            public void onResponse(String response){
                ...
                if(response.equals("error")){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.Rondines.class);
                                    startActivity(i);
                                    finish();
                                }
                            }).create().show();
...
*/
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.Rondines.class);
