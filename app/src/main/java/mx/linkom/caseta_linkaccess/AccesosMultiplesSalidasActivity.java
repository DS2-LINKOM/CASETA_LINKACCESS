...
public class AccesosMultiplesSalidasActivity extends mx.linkom.caseta_linkaccess.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.AccesosMorososActivity.class);
                startActivity(i);
                finish();
            }
        });
