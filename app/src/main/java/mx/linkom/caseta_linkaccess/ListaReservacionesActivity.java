...
import mx.linkom.caseta_linkaccess.adaptadores.ListasClassReservaciones;
...
public class ListaReservacionesActivity extends AppCompatActivity {
    ...
    public void reservaciones() {
        String URL = "https://linkaccess.kap-adm.mx//plataforma/casetaV2/controlador/link_access/reservaciones_mes.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.ReservacionActivity.class);
