...
public class ListaReservacionesActivity extends AppCompatActivity {
    ...
    public void reservaciones() {
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/reservaciones_mes.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
