...
import mx.linkom.caseta_linkaccess.Animaciones.AnimationUtil;
...
import mx.linkom.caseta_linkaccess.offline.Servicios.testInternet;

public class DashboardActivity extends  mx.linkom.caseta_linkaccess.Menu {
    ...
    public void Registro (){
        try {
            fAuth.createUserWithEmailAndPassword(mx.linkom.caseta_linkaccess.Global.EMAIL, mx.linkom.caseta_linkaccess.Global.PASS)
    ...
    public void Sesion (){
        try {
            fAuth.signInWithEmailAndPassword(mx.linkom.caseta_linkaccess.Global.EMAIL, mx.linkom.caseta_linkaccess.Global.PASS)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                    if (position == 0 ){
                                        Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EntradasSalidasActivity.class);
                ...
                if (entrada != null) {
                    ...
                    gridList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                ...
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.ReportesActivity.class);
                                startActivity(docugen);
                                finish();
