...
import mx.linkom.caseta_linkaccess.adaptadores.ModuloClassGrid;
import mx.linkom.caseta_linkaccess.adaptadores.adaptador_Modulo;

public class ReportesActivity extends mx.linkom.caseta_linkaccess.Menu {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                Intent reservaciones = new Intent(getApplication(), mx.linkom.caseta_linkaccess.ListaReservacionesActivity.class);
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                   Intent placas = new Intent(getApplication(), mx.linkom.caseta_linkaccess.PlacasActivity.class);
                ...
                if (entrada != null) {
                    ...
                    gridList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                Intent inci = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EscaneoTrabajadorActivity.class);
                                startActivity(inci);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                               Intent inci = new Intent(getApplication(), mx.linkom.caseta_linkaccess.IncidenciaActivity.class);
                                startActivity(inci);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                Intent placas = new Intent(getApplication(), mx.linkom.caseta_linkaccess.CorrespondenciaActivity.class);
                                startActivity(placas);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                           ...
                           // if(position==0) {
                            //    Intent placas = new Intent(getApplication(), mx.linkom.caseta_linkaccess.ListaRondinesActivity.class);
                           //     startActivity(placas);
                           //     finish();
                           //mega }
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_linkaccess.DashboardActivity.class);
