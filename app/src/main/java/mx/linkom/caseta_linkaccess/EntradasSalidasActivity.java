...
public class EntradasSalidasActivity extends  mx.linkom.caseta_linkaccess.Menu {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            if(position==0) {
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EscaneoVisitaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EscaneoVisitaSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
            ...
            public void onEntrada(Object entrada, View view) {
                if (entrada != null) {
                    ...
                    gridList4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                           if(position==0){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EscaneoTrabajadorEntradaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_linkaccess.EscaneoTrabajadorSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
