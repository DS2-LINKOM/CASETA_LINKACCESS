...
public class RegTrab2Activity extends mx.linkom.caseta_linkaccess.Menu {
    ...
    public void trabajadores() {
        String URL = "https://linkaccess.elkm.mx/plataforma/casetaV2/controlador/link_access/reg_traba4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
